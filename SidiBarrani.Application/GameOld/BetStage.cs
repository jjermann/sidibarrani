    ...
    public class BetStage
    {
        ...
        private BetResult? GetBetResult()
        {
            ...
            if (barraniBetAction != null)
            {
                ...
                return new BetResult(bettingTeam, lastBetBetAction.Bet!, true, true);
            }
            ...
            if (sidiBetAction != null)
            {
                ...
                {
                    return new BetResult(bettingTeam, lastBetBetAction.Bet!, true, false);
                }
                return null;
            }
            ...
            {
                return new BetResult(bettingTeam, lastBetBetAction!.Bet!);
            }
            return null;
        }
        ...
        private IList<BetAction> GetValidBetActions()
        {
            ...
            if (lastBetAction != null && lastBetAction.Type == BetActionType.Sidi)
            {
                ...
                {
                    betActionList.Add(new BetAction(BetActionType.Barrani, PlayerInfo: opposingTeam.Player1));
                    if (nextActiveOpposingPlayer == opposingTeam.Player1)
                    {
                        betActionList.Add(new BetAction(BetActionType.Pass, PlayerInfo: opposingTeam.Player1));
                    }
                }
                if (!alreadyPassed.Contains(opposingTeam.Player2))
                {
                    betActionList.Add(new BetAction(BetActionType.Barrani, PlayerInfo: opposingTeam.Player2));
                    if (nextActiveOpposingPlayer == opposingTeam.Player2)
                    {
                        betActionList.Add(new BetAction(BetActionType.Pass, PlayerInfo: opposingTeam.Player2));
                    }
                }
            ...
            var validBetActions = validNewBets
                .Select(b => new BetAction(BetActionType.Bet, b, PlayerInfo: CurrentPlayer))
                .ToList();
            ...
            if (generalBetAction != null)
            {
                ...
                {
                    validBetActions.Add(new BetAction(BetActionType.Pass, PlayerInfo: nextActiveOpposingPlayer));
                }
            }
            else
            {
                validBetActions.Add(new BetAction(BetActionType.Pass, PlayerInfo: CurrentPlayer));
            }
            if (lastBetAction != null)
            {
                ...
                {
                    validBetActions.Add(new BetAction(BetActionType.Sidi, PlayerInfo: opposingTeam.Player1));
                }
                if (!passingOppositionPlayer.Contains(opposingTeam.Player2))
                {
                    validBetActions.Add(new BetAction(BetActionType.Sidi, PlayerInfo: opposingTeam.Player2));
                }
            }
